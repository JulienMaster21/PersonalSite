...
class TestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table("tests")->insert([
            ...
            ["blok" => 3,   "cursus" => "Framework Development 1",          "subject" => "Toets 1",                 "completed" => true,   "grade" => 10.0,    "EC" => 5.0],
            ["blok" => 3,   "cursus" => "Framework Project 1",              "subject" => "Toets 1",                 "completed" => true,   "grade" => 7.0,    "EC" => 5.0],
            ["blok" => 3,   "cursus" => "Professional Skills 2",            "subject" => "Toets 1",                 "completed" => false,   "grade" => NULL,    "EC" => 1.25],
            ["blok" => 3,   "cursus" => "Professional Skills 2",            "subject" => "Toets 2",                 "completed" => true,   "grade" => 8.3,    "EC" => 1.25],
            ["blok" => 3,   "cursus" => "Professionele Werkplek 1",         "subject" => "Toets 1",                 "completed" => true,   "grade" => 8.6,    "EC" => 2.5],
