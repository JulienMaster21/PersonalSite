...
@section("navbar")
    ...
    <section class="mobile_navbar" id="dropdown">
        ...
        <a href="{{route("about")}}">
            <div class="mobile_navbutton">Over mij</div>
        </a>
    ...
    <section class="navbar">
        <div class="navcontainer">
            ...
            <a href="{{route("about")}}">
                <div class="navbutton">Over mij</div>
            </a>
            <a href="{{route("dashboard")}}">
...
@section("content")
    ...
    <ol>
        ...
        <li>
            <a class="link" href="#prestatie">Prestatiemotivatie</a>
        </li>
        <li>
            <a class="link" href="#carriere">Carrièreankers</a>
        </li>
        <li>
            <a class="link" href="#conclusie">Conclusie</a>
        </li>
        <li>
    ...
    <p>Dan Pink heeft ook nog wat te zeggen over motivatie. In zijn TED talk Pink (z.d.) beschrijft hij "The Candle problem".
        ...
        Een groep wordt gevraagd om deze test in een ongeveer gemiddelde tijd af te ronden en aan de andere groep wordt verteldt dat zij een
    ...
    <p>Volgens het artikel van "Prestatiemotivatie ontwikkelen" (z.d.) is intrinsieke motivatie belangrijk voor het zakenleven. Verder wordt gezegd dat prestatiemotivatie
    ...
    <p>Ik heb op de middelbare school als keuzevak voor informatica gekozen en ik heb hiervoor ook mijn profielwerkstuk gemaakt. Ik vond computers altijd
    ...
    <p>Ik ben nooit echt sociaal geweest en heb nooit de drang voor vrienden of contacten gevoeld. Ik moet zeggen dat het niet helpt dat ik Autistisch ben.
    ...
    <ul>
        <li>
            <a class="link" href="https://controlandmotivate.nl/4-typen-motivatie/">Ken jij de 4 typen motivatie? | Control & Motivate. (2016, 28 december). Geraadpleegd op 17 september 2018, van https://controlandmotivate.nl/4-typen-motivatie/</a>
        </li>
        <li>
            <a class="link" href="https://www.desteven.nl/leerdoelen/persoonlijke-leerdoelen/autonomie-leerdoelen/motivatie">Stevens, J. (z.d.). Motivatie en zelfmotivatie: Kunt u uzelf motiveren? Hoe dan? Geraadpleegd op 17 september 2018, van https://www.desteven.nl/leerdoelen/persoonlijke-leerdoelen/autonomie-leerdoelen/motivatie</a>
        </li>
        <li>
            <a class="link" href="https://www.leren.nl/cursus/management/motiveren/wat-is-motivatie.html">Wat is motivatie? - cursus Medewerkers motiveren. (z.d.). Geraadpleegd op 17 september 2018, van https://www.leren.nl/cursus/management/motiveren/wat-is-motivatie.html</a>
        </li>
        <li>
            <a class="link" href="https://www.ted.com/talks/dan_pink_on_motivation">Pink, D. (z.d.). The puzzle of motivation [Video]. Geraadpleegd op 18 september 2018, van https://www.ted.com/talks/dan_pink_on_motivation</a>
        </li>
        <li>
            <a class="link" href="http://www.carrieretijger.nl/functioneren/management/prestatiemotivatie">Prestatiemotivatie ontwikkelen. (z.d.). Geraadpleegd op 18 september 2018, van http://www.carrieretijger.nl/functioneren/management/prestatiemotivatie</a>
        </li>
        <li>
            <a class="link" href="https://nieuws.testnet.org/artikelen/de-motivatie-van-software-testend-nederland/">Van Der Veen, L. (z.d.). De motivatie van software testend Nederland – TestNet Nieuws Magazine. Geraadpleegd op 18 september 2018, van https://nieuws.testnet.org/artikelen/de-motivatie-van-software-testend-nederland/</a>
        </li>
    </ul>
    <h3>Testen</h3>
    <ul>
        <li>
            <a class="link" href="https://www.123test.nl/prestatiemotivatie/">Prestatiemotivatie | test je intrinsieke en extrinsieke motivatie | 123test.nl. (z.d.). Geraadpleegd op 18 september 2018, van https://www.123test.nl/prestatiemotivatie/</a>
        </li>
        <li>
            <a class="link" href="https://www.123test.nl/schein/">Carrièreankers | test je drijfveren (Schein) | 123test.nl. (z.d.). Geraadpleegd op 18 september 2018, van https://www.123test.nl/schein/</a>
        </li>
    </ul>
@endsection
